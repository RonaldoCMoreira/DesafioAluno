...
public class CadastrarGerente {
	...
	public void registrarGerente(JTextField opcaoMenuJText, JFrame frameMenuInicial,
		...
		frameTelaCadastro.setSize(200, 400);
		frameTelaCadastro.setTitle("Inserir Gerente");
		frameTelaCadastro.setLocation(300, 400);
		...
		painelTelaCadastro.add(estadoTextoLabel);

		JTextField estadoTextField = new JTextField(10);
		painelTelaCadastro.add(estadoTextField);

		JLabel ruaTextoLabel = new JLabel(ruaTexto);
		painelTelaCadastro.add(ruaTextoLabel);

		JTextField ruaTextField = new JTextField(10);
		painelTelaCadastro.add(ruaTextField);

		JLabel numeroTextoLabel = new JLabel(numeroTexto);
		painelTelaCadastro.add(numeroTextoLabel);

		JTextField numeroTextField = new JTextField(10);
		painelTelaCadastro.add(numeroTextField);
		...
		CadastrarGerenteControle cadastrarGerenteControle = new CadastrarGerenteControle(frameTelaCadastro,
				frameMenuInicial, nomeTextField, cpfTextField, regionalTextField, estadoTextField, ruaTextField,
				numeroTextField, repositorioGerente);
